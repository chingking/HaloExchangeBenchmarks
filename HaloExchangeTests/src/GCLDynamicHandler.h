...
class GCLDynamicHandler : public GCLHandlerBase
{
public:
  typedef GCL::halo_exchange_dynamic_ut<GCL::layout_map<0, 1, 2>, GCL::layout_map<0, 1, 2>, double, 3, arch, packing_version> gcl_handler_type;
